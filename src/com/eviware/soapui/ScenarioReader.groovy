...
class ScenarioReader {
  ...
  public void cfgSnippets() {
    ...
    this.addXSnippet('NONPROP_MEASURE_TPL', '{"measureId": "${measure_id}","value": {"caseCount": ${case_count},"isEndToEndReported": ${end_to_end},"numerator": ${numerator},"denominator": ${denominator},"denominatorException": ${denominator_exc},"numeratorExclusion":${numerator_exc},"reportingRate":${reporting_rate},"performanceRate":${performanceRate},"observationInstances":${observation_inst}}}')
    this.addXSnippet('2017_NONPROP_MEASURE_TPL', '{"measureId": "${measure_id}","value": {"caseCount": ${case_count},"isEndToEndReported": ${end_to_end},"numerator": ${numerator},"denominator": ${denominator},"denominatorException": ${denominator_exc},"numeratorExclusion":${numerator_exc}}}')
    this.addXSnippet('SINGLE_MEASURE', '{"measureId":"${measure_id}","value":{"caseCount": ${case_count},"isEndToEndReported":${end_to_end},"performanceMet":${perf_met},"eligiblePopulationException":${perf_excep},"eligiblePopulationExclusion":${perf_exclu},"performanceNotMet":${perf_not_met},"eligiblePopulation":${pop_total}}}')
    this.addXSnippet('MULTI_MEASURE', '{"measureId":"${measure_id}","value":{"caseCount": ${case_count},"isEndToEndReported":${end_to_end},"strata":[${STRATUM}]}}')
    ...
    this.addXSnippet('PROP_MULTI_MEASURE_TPL', '{"measureId":"${measure_id}","value":{"caseCount": ${case_count},"isEndToEndReported":${end_to_end},"reportingRate":${reportingRate},"performanceRate":${performanceRate},"strata":[${STRATUM}]}}')
